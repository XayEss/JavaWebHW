...
<div id="sidebar">
	...
	<h2>Боковое меню</h2>
	<ul>
		<li><a href="?category=raccoons">Еноты</a></li>
		<li><a href="?category=pandas">Панды</a></li>
		<li><a href="?category=ravens">Вороны</a></li>
		<li><a href="?category=Magical Creatures">Магические
				существа</a></li>
...
<div id="footer">
	<p>Copyright (c) by Селюк Александер</p>
</div>
